...
pub use self::bitflags_features::Features;

impl<'a> flatbuffers::Follow<'a> for Features {
  type Inner = Self;
  #[inline]
  fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
...
impl flatbuffers::Push for Features {
...
impl flatbuffers::EndianScalar for Features {
  #[inline]
  fn to_little_endian(self) -> Self {
...
impl<'a> Compilation<'a> {
  ...
  pub fn features(&self) -> Features {
    self._tab.get::<Features>(Compilation::VT_FEATURES, Some(Default::default())).unwrap()
  }
}
...
impl<'a: 'b, 'b> CompilationBuilder<'a, 'b> {
  ...
  pub fn add_features(&mut self, features: Features) {
    self.fbb_.push_slot::<Features>(Compilation::VT_FEATURES, features, Default::default());
  }
  #[inline]
