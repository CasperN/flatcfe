...
pub mod flatbuffers_compiler {
    ...
    impl NonPresenceBehavior {
        ...
        pub const ENUM_VALUES: &'static [Self] = &[Self::Optional, Self::Default, Self::Required];
        /// Returns the variant's name or "" if unknown.
        pub fn variant_name(self) -> Option<&'static str> {
            match self {
    ...
    impl<'a> Schema<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.imported_symbols {
                builder.add_imported_symbols(x);
            }
            if let Some(x) = args.symbols {
                builder.add_symbols(x);
            }
    ...
    impl<'a: 'b, 'b> SchemaBuilder<'a, 'b> {
        ...
        pub fn add_includes(
            &mut self,
            includes: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u32>>,
        ) {
            self.fbb_
        ...
        pub fn add_symbols(
            &mut self,
            symbols: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u32>>,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Schema::VT_SYMBOLS, symbols);
        }
        #[inline]
        pub fn add_imported_symbols(
            &mut self,
            imported_symbols: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u32>>,
        ) {
    ...
    impl<'a> Type<'a> {
        ...
        pub fn element_type(&self) -> BaseType {
            self._tab
                .get::<BaseType>(Type::VT_ELEMENT_TYPE, Some(BaseType::None))
                .unwrap()
        }
    ...
    impl<'a: 'b, 'b> TypeBuilder<'a, 'b> {
        ...
        pub fn add_element_type(&mut self, element_type: BaseType) {
            self.fbb_
                .push_slot::<BaseType>(Type::VT_ELEMENT_TYPE, element_type, BaseType::None);
        }
        #[inline]
        ...
        pub fn add_fixed_length(&mut self, fixed_length: u16) {
            self.fbb_
                .push_slot_always::<u16>(Type::VT_FIXED_LENGTH, fixed_length);
        }
        #[inline]
    ...
    impl<'a> TableField<'a> {
        ...
        pub fn non_presence_behavior(&self) -> NonPresenceBehavior {
            self._tab
                .get::<NonPresenceBehavior>(
                    TableField::VT_NON_PRESENCE_BEHAVIOR,
                    Some(NonPresenceBehavior::Optional),
                )
                .unwrap()
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> TableFieldBuilder<'a, 'b> {
        ...
        pub fn add_non_presence_behavior(&mut self, non_presence_behavior: NonPresenceBehavior) {
            self.fbb_.push_slot::<NonPresenceBehavior>(
                TableField::VT_NON_PRESENCE_BEHAVIOR,
                non_presence_behavior,
                NonPresenceBehavior::Optional,
            );
        }
        #[inline]
    ...
    impl<'a> EnumVariant<'a> {
        #[inline]
        pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
            EnumVariant { _tab: table }
        }
        #[allow(unused_mut)]
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
            args: &'args EnumVariantArgs<'args>,
        ) -> flatbuffers::WIPOffset<EnumVariant<'bldr>> {
        ...
        pub fn name(&self) -> Option<&'a str> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(EnumVariant::VT_NAME, None)
        }
        #[inline]
        pub fn metadata(&self) -> Option<Metadata<'a>> {
            self._tab
        ...
        pub fn type_(&self) -> Option<Type<'a>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Type<'a>>>(EnumVariant::VT_TYPE_, None)
        }
    }
    ...
    impl<'a: 'b, 'b> EnumVariantBuilder<'a, 'b> {
        ...
        pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(EnumVariant::VT_NAME, name);
        }
        #[inline]
        pub fn add_metadata(&mut self, metadata: flatbuffers::WIPOffset<Metadata<'b>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<Metadata>>(
                    EnumVariant::VT_METADATA,
                    metadata,
                );
        }
        #[inline]
        pub fn add_type_(&mut self, type_: flatbuffers::WIPOffset<Type<'b>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<Type>>(EnumVariant::VT_TYPE_, type_);
        }
        #[inline]
    ...
    impl<'a> RpcMethod<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.return_type {
                builder.add_return_type(x);
            }
            if let Some(x) = args.argument_type {
                builder.add_argument_type(x);
            }
            if let Some(x) = args.metadata {
                builder.add_metadata(x);
            }
        ...
        pub fn argument_type(&self) -> Option<Type<'a>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Type<'a>>>(RpcMethod::VT_ARGUMENT_TYPE, None)
        }
        #[inline]
        pub fn return_type(&self) -> Option<Type<'a>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Type<'a>>>(RpcMethod::VT_RETURN_TYPE, None)
        }
    }
    ...
    impl<'a> Union<'a> {
        ...
        pub fn variants(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<EnumVariant<'a>>>>
        {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<flatbuffers::ForwardsUOffset<EnumVariant<'a>>>,
            >>(Union::VT_VARIANTS, None)
        }
    }
    ...
    pub struct UnionArgs<'a> {
        pub variants: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<EnumVariant<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b> UnionBuilder<'a, 'b> {
        ...
        pub fn add_variants(
            ...
            variants: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<EnumVariant<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Union::VT_VARIANTS, variants);
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> EnumBuilder<'a, 'b> {
        ...
        pub fn add_variants(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Enum::VT_VARIANTS, variants);
        }
        #[inline]
    ...
    impl<'a> Symbol<'a> {
        ...
        pub fn name(&self) -> &'a str {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(Symbol::VT_NAME, None)
                .unwrap()
        }
        #[inline]
        ...
        pub fn metadata(&self) -> Option<Metadata<'a>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Metadata<'a>>>(Symbol::VT_METADATA, None)
        }
        #[inline]
        pub fn detail_type(&self) -> Declaration {
            self._tab
                .get::<Declaration>(Symbol::VT_DETAIL_TYPE, Some(Declaration::NONE))
                .unwrap()
        }
    ...
    impl<'a: 'b, 'b> SymbolBuilder<'a, 'b> {
        ...
        pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Symbol::VT_NAME, name);
        }
        #[inline]
        pub fn add_metadata(&mut self, metadata: flatbuffers::WIPOffset<Metadata<'b>>) {
            self.fbb_
        ...
        pub fn add_detail_type(&mut self, detail_type: Declaration) {
            self.fbb_.push_slot::<Declaration>(
                Symbol::VT_DETAIL_TYPE,
                detail_type,
                Declaration::NONE,
            );
        }
        ...
        pub fn add_detail(&mut self, detail: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Symbol::VT_DETAIL, detail);
        }
        #[inline]
    ...
    impl<'a> CodeGenOptions<'a> {
        #[inline]
        pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
            CodeGenOptions { _tab: table }
        }
        #[allow(unused_mut)]
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
            args: &'args CodeGenOptionsArgs<'args>,
        ) -> flatbuffers::WIPOffset<CodeGenOptions<'bldr>> {
            let mut builder = CodeGenOptionsBuilder::new(_fbb);
            if let Some(x) = args.filename_extension {
                builder.add_filename_extension(x);
            }
            if let Some(x) = args.filename_suffix {
                builder.add_filename_suffix(x);
            }
            if let Some(x) = args.include_prefix {
                builder.add_include_prefix(x);
            }
            if let Some(x) = args.object_suffix {
                builder.add_object_suffix(x);
            }
            if let Some(x) = args.object_prefix {
                builder.add_object_prefix(x);
            }
        ...
        pub fn mutable_buffer(&self) -> bool {
            self._tab
                .get::<bool>(CodeGenOptions::VT_MUTABLE_BUFFER, Some(false))
                .unwrap()
        }
        ...
        pub fn one_file(&self) -> bool {
            self._tab
                .get::<bool>(CodeGenOptions::VT_ONE_FILE, Some(false))
                .unwrap()
        }
        ...
        pub fn generate_included(&self) -> bool {
            self._tab
                .get::<bool>(CodeGenOptions::VT_GENERATE_INCLUDED, Some(false))
                .unwrap()
        }
        ...
        pub fn generate_name_strings(&self) -> bool {
            self._tab
                .get::<bool>(CodeGenOptions::VT_GENERATE_NAME_STRINGS, Some(false))
                .unwrap()
        }
        ...
        pub fn generate_object_based_api(&self) -> bool {
            self._tab
                .get::<bool>(CodeGenOptions::VT_GENERATE_OBJECT_BASED_API, Some(false))
                .unwrap()
        }
        ...
        pub fn object_prefix(&self) -> Option<&'a str> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CodeGenOptions::VT_OBJECT_PREFIX, None)
        }
        /// Suffix for native version of Flatbuffers objects.
        #[inline]
        pub fn object_suffix(&self) -> Option<&'a str> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CodeGenOptions::VT_OBJECT_SUFFIX, None)
        }
        /// Generate `==` operator.
        #[inline]
        pub fn generate_compare(&self) -> bool {
            self._tab
                .get::<bool>(CodeGenOptions::VT_GENERATE_COMPARE, Some(false))
                .unwrap()
        }
        ...
        pub fn include_prefix(&self) -> Option<&'a str> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CodeGenOptions::VT_INCLUDE_PREFIX, None)
        }
        /// Keep original prefix when including generated files.
        #[inline]
        pub fn keep_include_path(&self) -> bool {
            self._tab
                .get::<bool>(CodeGenOptions::VT_KEEP_INCLUDE_PATH, Some(false))
                .unwrap()
        }
        ...
        pub fn binary_schema_gen_embed(&self) -> bool {
            self._tab
                .get::<bool>(CodeGenOptions::VT_BINARY_SCHEMA_GEN_EMBED, Some(false))
                .unwrap()
        }
        ...
        pub fn filename_suffix(&self) -> Option<&'a str> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CodeGenOptions::VT_FILENAME_SUFFIX, None)
        }
        ...
        pub fn filename_extension(&self) -> Option<&'a str> {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                CodeGenOptions::VT_FILENAME_EXTENSION,
                None,
            )
        }
        ...
        pub fn generate_grpc(&self) -> bool {
            self._tab
                .get::<bool>(CodeGenOptions::VT_GENERATE_GRPC, Some(false))
                .unwrap()
        }
    }
    ...
    impl<'a: 'b, 'b> CodeGenOptionsBuilder<'a, 'b> {
        ...
        pub fn add_mutable_buffer(&mut self, mutable_buffer: bool) {
            self.fbb_
                .push_slot::<bool>(CodeGenOptions::VT_MUTABLE_BUFFER, mutable_buffer, false);
        }
        #[inline]
        pub fn add_one_file(&mut self, one_file: bool) {
            self.fbb_
                .push_slot::<bool>(CodeGenOptions::VT_ONE_FILE, one_file, false);
        }
        #[inline]
        pub fn add_generate_included(&mut self, generate_included: bool) {
            self.fbb_.push_slot::<bool>(
                CodeGenOptions::VT_GENERATE_INCLUDED,
                generate_included,
                false,
            );
        }
        ...
        pub fn add_generate_name_strings(&mut self, generate_name_strings: bool) {
            self.fbb_.push_slot::<bool>(
                CodeGenOptions::VT_GENERATE_NAME_STRINGS,
        ...
        pub fn add_generate_object_based_api(&mut self, generate_object_based_api: bool) {
            self.fbb_.push_slot::<bool>(
                CodeGenOptions::VT_GENERATE_OBJECT_BASED_API,
        ...
        pub fn add_object_prefix(&mut self, object_prefix: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                CodeGenOptions::VT_OBJECT_PREFIX,
                object_prefix,
            );
        }
        #[inline]
        pub fn add_object_suffix(&mut self, object_suffix: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                CodeGenOptions::VT_OBJECT_SUFFIX,
                object_suffix,
            );
        }
        #[inline]
        pub fn add_generate_compare(&mut self, generate_compare: bool) {
            self.fbb_.push_slot::<bool>(
                CodeGenOptions::VT_GENERATE_COMPARE,
                generate_compare,
                false,
            );
        }
        ...
        pub fn add_include_prefix(&mut self, include_prefix: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                CodeGenOptions::VT_INCLUDE_PREFIX,
                include_prefix,
            );
        }
        #[inline]
        pub fn add_keep_include_path(&mut self, keep_include_path: bool) {
            self.fbb_.push_slot::<bool>(
                CodeGenOptions::VT_KEEP_INCLUDE_PATH,
                keep_include_path,
                false,
            );
        }
        ...
        pub fn add_binary_schema_gen_embed(&mut self, binary_schema_gen_embed: bool) {
            self.fbb_.push_slot::<bool>(
                CodeGenOptions::VT_BINARY_SCHEMA_GEN_EMBED,
        ...
        pub fn add_filename_suffix(&mut self, filename_suffix: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                CodeGenOptions::VT_FILENAME_SUFFIX,
                filename_suffix,
            );
        }
        #[inline]
        pub fn add_filename_extension(
            &mut self,
            filename_extension: flatbuffers::WIPOffset<&'b str>,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                CodeGenOptions::VT_FILENAME_EXTENSION,
                filename_extension,
        ...
        pub fn add_generate_grpc(&mut self, generate_grpc: bool) {
            self.fbb_
                .push_slot::<bool>(CodeGenOptions::VT_GENERATE_GRPC, generate_grpc, false);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> CodeGenOptionsBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl std::fmt::Debug for CodeGenOptions<'_> {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            ...
            ds.field(
                "generate_object_based_api",
                &self.generate_object_based_api(),
            );
    ...
    impl<'a> Compilation<'a> {
        #[inline]
        pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
            Compilation { _tab: table }
        }
        #[allow(unused_mut)]
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
            args: &'args CompilationArgs<'args>,
        ) -> flatbuffers::WIPOffset<Compilation<'bldr>> {
            let mut builder = CompilationBuilder::new(_fbb);
            if let Some(x) = args.features {
                builder.add_features(x);
            }
            if let Some(x) = args.code_gen_options {
                builder.add_code_gen_options(x);
            }
        ...
        pub fn symbols(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Symbol<'a>>>> {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<flatbuffers::ForwardsUOffset<Symbol<'a>>>,
            >>(Compilation::VT_SYMBOLS, None)
        }
        ...
        pub fn schemas(
            ...
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<flatbuffers::ForwardsUOffset<Schema<'a>>>,
            >>(Compilation::VT_SCHEMAS, None)
        }
        /// Common code-generator options that apply to most or all languages.
        #[inline]
        pub fn code_gen_options(&self) -> Option<CodeGenOptions<'a>> {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<CodeGenOptions<'a>>>(
                    Compilation::VT_CODE_GEN_OPTIONS,
                    None,
                )
        }
    ...
    pub struct CompilationArgs<'a> {
        pub symbols: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Symbol<'a>>>,
            >,
        >,
        pub schemas: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Schema<'a>>>,
            >,
        >,
    ...
    impl<'a: 'b, 'b> CompilationBuilder<'a, 'b> {
        ...
        pub fn add_symbols(
            &mut self,
            symbols: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Symbol<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Compilation::VT_SYMBOLS, symbols);
        }
        #[inline]
        pub fn add_schemas(
            &mut self,
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Compilation::VT_SCHEMAS, schemas);
        }
        #[inline]
        pub fn add_code_gen_options(
            &mut self,
            code_gen_options: flatbuffers::WIPOffset<CodeGenOptions<'b>>,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<CodeGenOptions>>(
                    Compilation::VT_CODE_GEN_OPTIONS,
                    code_gen_options,
                );
        }
        ...
        pub fn add_features(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Compilation::VT_FEATURES, features);
        }
        #[inline]
